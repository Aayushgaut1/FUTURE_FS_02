      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition font-medium"
            >
              Sign In
            </button>
          </form>
          ...
          <div className="mt-6 p-4 bg-indigo-50 rounded-lg border border-indigo-100">
            ...
            <p className="text-xs text-indigo-700">
              Email: demo@leadflow.com | Password: demo123
            </p>
          </div>
        </div>
